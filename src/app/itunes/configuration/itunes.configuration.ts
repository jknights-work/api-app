...
import { ItunesEventHandler } from '../handler/itunes.event.handler';
...
@Injectable()
export class ItunesConfiguration implements CommonConfiguration {
    ...
    public getEventHandler() : ItunesEventHandler {
        return new ItunesEventHandler(new AppHelper());
    }
